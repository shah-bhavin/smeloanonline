...
<div id="qbox-container">
    <div class="row">
        <div class="col-md-4"></div>
            <div class="col-md-4">
                <form class="needs-validation text-center" id="form-wrapper" method="post" name="form-wrapper" action="{{ route('save.loan') }}">
                    <div id="steps-container">
                        @csrf
                        <input type="hidden" value="Subsidy Loan" name="table">
